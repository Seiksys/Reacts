...
function App() {
  return (
    <div className="bg-dark">
      <Header />
      <div className="container-fluid text-light text-center d-flex align-items-center justify-content-center" style={{ height: "666px", background: "linear-gradient(to right, rgba(0, 0, 0, 0) 10%, #000000 100%)" }}>
        <div className="row">
